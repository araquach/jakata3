...
<?php Yii::app()->facebook->ogTags['og:description'] = "Hundreds of poundsworth of prizes to be won! GHD Styling tools set, meal for 4 at Grill on the Square plus Colour & Cut package with product hamper!"; ?>
<?php Yii::app()->facebook->ogTags['og:image'] =  "http://www.jakatasalon.co.uk/images/main/.jpg"; ?>
...
<div id="prize_entry">
<p>To enter simply purchase prize draw tickets from salon reception. Tickets are £1 each and you can buy as many as you like!</p>
<p>For every Christmas Gift pack purchased you will also receive a FREE prize draw ticket.</p>
