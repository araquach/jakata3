...
<?php Yii::app()->facebook->ogTags['og:description'] = "People often have to cancel last minute this time of year - which leaves us with appointment slots that we need to fill! Call the salon on the day and if you can fill one of our gaps you'll get your hair done at a special price!
Last Minute Men's Cut & Style - only £12 or Express Cut for just £8 "; ?>
...
<section id="offers">
	...
	<p>We know that men can often be a bit last minute, and with most of our clients pre-booking months back, our prime time slots are nearly already gone!</p>
	<p>If you have a tendency to cut it a bit fine - don't despair,  there's a chance we can still get you sorted. People often have to cancel last minute this time of year - which leaves us with appointment slots that we need to fill!</p>
