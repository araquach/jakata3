...
$this->pageTitle=Yii::app()->name . 'Hairdressing News Archive';
?>
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/miracleoil_light.jpg" alt="BC Oil Miracle" width="135" height="155 ">
...
<p>BC Oil Miracle Finishing Treatments are everything a hair oil should be, without overburdening.</p>
 ...
 <img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/tigi_oil.jpg" alt="Tigi S Factor True Lasting Colour" width="135" height="155 ">
 <hgroup>
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/bed-head-products.jpg" width="150" height="188">
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/parkroyale.jpg" alt="Charity Hair Styling" width="150" height="100">
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/vicky.jpg" alt="Vicki" width="135" height="203">
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/giftvouchers.jpg" width="135" height="192">
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/hj-cover.jpg" alt="Hairdressers Journal" width="143" height="180">
...
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/redkenarticle.jpg" alt="Midweek Guardian Article" width="135" height="165"></a>
...
<section class="hidden">
<p>If you don't receive it - don't worry - its available here as a <a href="<?php echo Yii::app()->request->baseUrl; ?>/images/midweek_redken.pdf">PDF download</a></p>
...
<a name="Shell"></a>
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/new-staff_0965.jpg" width="135" height="165" alt="Michelle">
...
<article class="article">
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/emily_side.jpg" width="135" height="165" alt="Paul Kemp Hairdressing imagary">
...
<section class="hidden">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/pk_graphic copy.jpg" width="135" height="118" alt="Paul Kemp Hairdressing">     
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/team.jpg" width="135" height="90" alt="Paul Kemp Team">
...
<article class="article">
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/Jo_0581.jpg" width="135" height="188" alt="Joanne Mahoney">
...
<article class="article">
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/redkencomplarge.jpg" width="135" height="180" alt="Redken competition">
...
<article class="article">
<section class="visible">
<img src="<?php echo Yii::app()->request->baseUrl; ?>/images/newspics/nicole-kidman-braid.jpg" width="135" height="182" alt="Nicole Kidman braid">
